...
import { d as House, f as Flame, g as Bell, h as ChartColumn, i as Trophy, m as ChevronLeft, n as User, o as SquarePen, p as Crown, r as UserRound, s as Sparkles, t as X, u as ListChecks } from "../_libs/lucide-react.mjs";
import { n as gsapWithCSS, t as ScrollTrigger } from "../_libs/gsap.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DMnTEcCG.js
...
function PhoneMockup({ children, className, screenClassName, tilt = "none", label = "Mediceen mobile app preview" }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("relative aspect-[9/18] w-[min(60vw,15rem)] shrink-0 overflow-hidden rounded-[2.2rem] p-[3px]", "bg-[linear-gradient(160deg,oklch(0.86_0.01_260),oklch(0.42_0.02_260)_45%,oklch(0.72_0.01_260))]", "shadow-phone transition-transform duration-500 ease-out", className),
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("@container relative h-full w-full overflow-hidden rounded-[1.75rem] bg-background", screenClassName),
				children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "block text-balance-tight font-display text-[clamp(2.8rem,6.5vw,4.8rem)] font-semibold text-brand-ink",
										children: "Prepare smarter for MECEE-BL"
									}),
									" ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "mt-2 block font-display text-[clamp(1.1rem,1.8vw,1.4rem)] font-medium text-muted-foreground",
										children: "Medical entrance exam prep for Nepal"
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						className: "flex h-7 w-7 items-center justify-center rounded-full bg-success text-[0.6rem] font-semibold text-white",
						children: "BR"
					})]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-3 px-4",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2 rounded-xl border border-warning/30 bg-warning-soft px-3 py-2.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "truncate text-[0.68rem] font-semibold text-brand-ink",
							children: "7 day streak"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "truncate text-[0.58rem] text-muted-foreground",
							children: "2 days to a new record"
						})]
					})]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-3 px-4",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative overflow-hidden rounded-2xl bg-[linear-gradient(135deg,var(--teal),var(--brand))] p-3.5",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, {
								...
								className: "text-[0.55rem] font-semibold uppercase tracking-[0.18em] text-white/90",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-1 text-[0.62rem] leading-snug text-white/75",
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[0.68rem] font-semibold text-brand-ink",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-full w-3/5 rounded-full bg-success" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-[0.58rem] text-muted-foreground",
							children: "8 questions left today"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-2.5 flex items-center justify-center rounded-xl bg-primary py-2",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-[0.65rem] font-semibold text-primary-foreground",
...
function McqExperience() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bg-card px-[7cqw] pb-[4cqw] pt-[7cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-display text-[5cqw] font-semibold text-brand-ink",
								children: "Practice MCQ"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-[3.8cqw] text-muted-foreground",
								children: [
									"Question ",
									CURRENT_QUESTION$1,
									" of ",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "w-[8cqw] shrink-0 text-right text-brand-ink",
							"aria-label": "Close",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
								className: "ml-auto h-[4cqw] w-[4cqw]",
								strokeWidth: 2.5
							})
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-[4cqw] flex items-center gap-[3cqw]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-[1.4cqw] flex-1 overflow-hidden rounded-xl bg-surface-2",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "h-full rounded-xl bg-brand",
							style: { width: `${CURRENT_QUESTION$1 / TOTAL_QUESTIONS$1 * 100}%` }
						})
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[3.8cqw] text-brand-ink",
						children: TIME_REMAINING$1
					})]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "px-[5.5cqw] pt-[5.5cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					"data-mcq-card": true,
					className: "rounded-2xl border border-border bg-surface-2 p-[5.5cqw] shadow-soft",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "inline-block rounded-full bg-success-soft px-[4.3cqw] py-[1.4cqw] text-[3.8cqw] font-medium text-success",
							children: q.subject
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
							className: "mt-[4cqw] font-display text-[4.9cqw] font-semibold leading-snug text-brand-ink",
							children: q.stem
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							className: "mt-[5.5cqw] space-y-[3cqw]",
							children: q.options.map((opt, oi) => {
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
									"data-mcq-option": oi,
									className: `flex items-center gap-[3cqw] rounded-xl border px-[4.3cqw] py-[2.9cqw] text-[4.3cqw] font-medium ${oi === SELECTED_INDEX ? "border-success bg-success-soft text-brand-ink" : "border-border bg-card text-brand-ink"}`,
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "flex h-[8.5cqw] w-[8.5cqw] shrink-0 items-center justify-center rounded-full bg-surface-2 text-[3.8cqw] font-bold text-muted-foreground",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "border-t border-border bg-card px-[5.5cqw] py-[5.5cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function FlashcardExperience() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "px-[5.7cqw] pb-[2.9cqw] pt-[5.7cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "w-[8.6cqw] shrink-0",
							"aria-hidden": "true"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex-1 text-center",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-display text-[4.3cqw] font-semibold text-brand-ink",
								children: "Practice Flash card"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-[3.3cqw] text-muted-foreground",
								children: [
									"Question ",
									CURRENT_QUESTION,
									" of ",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "w-[8.6cqw] shrink-0 text-right text-brand-ink",
							"aria-label": "Close",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
								className: "ml-auto h-[5cqw] w-[5cqw]",
								strokeWidth: 2.5
							})
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-[2.9cqw] flex items-center gap-[2.9cqw]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-[1.4cqw] flex-1 overflow-hidden rounded-xl bg-surface-2",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "h-full rounded-xl bg-brand",
						...
						className: "text-[3.7cqw] text-brand-ink",
						children: TIME_REMAINING
					})]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex justify-center pb-[2.9cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex items-center gap-[1.4cqw] rounded-full bg-card px-[3.6cqw] py-[1.4cqw] text-[4.3cqw] font-extrabold text-brand-ink shadow-soft",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						"aria-hidden": "true",
						children: "🔥"
					}), STREAK]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Face, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
							src: "/flashcard-front.png",
							alt: card.front,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "px-[5.7cqw] pb-[5.7cqw] pt-[1.4cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mb-[2.9cqw] text-center text-[3.7cqw] text-muted-foreground",
					children: "How well did you know it?"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-card-ratings": true,
					className: "grid grid-cols-3 gap-[2.9cqw]",
					children: [
...
function Rating({ label, emoji, tone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: `flex flex-col items-center gap-[0.7cqw] rounded-lg border py-[2.9cqw] text-center text-[3.4cqw] ${{
...
function ReviewQueueExperience() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bg-card px-[5.7cqw] pb-[5.7cqw] pt-[7.1cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-[2.9cqw]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, {
						className: "h-[5cqw] w-[5cqw] text-brand-ink",
						strokeWidth: 2.5
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-display text-[4.3cqw] font-semibold text-brand-ink",
					...
					className: "mt-[1.4cqw] pl-[8.6cqw] text-[3.3cqw] text-muted-foreground",
					children: [reviewQueueSummary.itemsDue, " items due"]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex-1 space-y-[5.7cqw] overflow-hidden px-[5.7cqw] pt-[5.7cqw]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-2xl border border-border bg-card p-[5cqw] shadow-soft",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[3.7cqw] font-semibold text-brand-ink",
							children: "Why review matters"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-[1.4cqw] text-[3.2cqw] leading-relaxed text-muted-foreground",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							className: "text-[3.6cqw] font-semibold text-brand",
							children: [12, " due"]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-[2.9cqw] overflow-hidden rounded-2xl border border-border bg-card shadow-soft",
						children: quizReviews.map((row, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: `flex items-center gap-[4.3cqw] px-[5cqw] py-[3.6cqw] ${i > 0 ? "border-t border-border" : ""}`,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "flex h-[11.4cqw] w-[11.4cqw] shrink-0 items-center justify-center rounded-[10px] bg-surface-2",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ListChecks, {
										className: "h-[5.7cqw] w-[5.7cqw] text-success",
										strokeWidth: 2
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "flex-1 text-[4.6cqw] font-medium text-brand-ink",
									children: row.subject
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "flex h-[8.6cqw] w-[8.6cqw] items-center justify-center rounded-full bg-surface-2 text-[3.4cqw] font-semibold text-muted-foreground",
									children: row.due
								})
							]
						}, row.subject))
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "mt-[2.9cqw] rounded-2xl border border-border bg-card p-[5cqw] shadow-soft",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-[3.7cqw] font-semibold text-brand-ink",
							children: [flashcardReviewSummary.count, " cards due"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-[0.7cqw] text-[3.2cqw] text-muted-foreground",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center justify-around border-t border-border bg-card px-[2.9cqw] py-[4.3cqw]",
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquarePen, {
						className: "h-[5cqw] w-[5cqw] text-muted-foreground",
						strokeWidth: 2
					}),
...
function MockTestExperience() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "bg-card px-[7cqw] pb-[4.3cqw] pt-[7.1cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-display text-[7.1cqw] font-bold text-brand-ink",
					children: "Weekly"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-[0.7cqw] text-[3.6cqw] text-muted-foreground",
					children: "One test a week keeps you sharp"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex-1 space-y-[7.1cqw] overflow-hidden px-[5.7cqw] pt-[5.7cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-2xl bg-gradient-to-br from-brand via-success/70 to-teal p-[5.7cqw]",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[3cqw] font-bold uppercase tracking-wider text-white/75",
							children: "This week's test"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-display text-[6.4cqw] font-bold text-white",
							children: weeklyMock.subject
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "mt-[0.7cqw] text-[3.9cqw] text-white/80",
							children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-[4.3cqw] flex items-center justify-between text-[3.3cqw] font-medium text-white/80",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-[1.4cqw] h-[1.4cqw] overflow-hidden rounded-full bg-white/30",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "mt-[2.9cqw] space-y-[3.6cqw]",
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[4.6cqw] font-semibold text-brand-ink",
										children: test.week
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "text-[3.3cqw] text-muted-foreground",
										children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "mt-[2.9cqw] h-[1.4cqw] overflow-hidden rounded-full bg-surface-2",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trophy, {
						className: "h-[5cqw] w-[5cqw] text-brand",
						strokeWidth: 2
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartColumn, {
						className: "h-[5cqw] w-[5cqw] text-muted-foreground",
...
function ResultsExperience() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PhoneStatusBar, { label: "Results" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex flex-1 flex-col items-center justify-center px-[8.6cqw] text-center",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[3.5cqw] font-semibold uppercase tracking-[0.22em] text-brand",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-[2.9cqw] text-[4cqw] text-muted-foreground",
					children: "156 of 200 correct · Weekly MECEE mock"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-[10cqw] grid w-full grid-cols-2 gap-[2.9cqw]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-[4.3cqw] w-full space-y-[2.9cqw]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "block rounded-xl bg-brand py-[2.9cqw] text-[4.1cqw] font-medium text-primary-foreground",
						children: "Review answers"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "block rounded-xl border border-border py-[2.9cqw] text-[4.1cqw] text-muted-foreground",
...
function Metric({ label, value, tone }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		className: `rounded-xl border p-[4.3cqw] text-left ${tone === "success" ? "border-success/30 bg-success-soft" : "border-brand/25 bg-brand-soft"}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-[3.3cqw] uppercase tracking-[0.18em] text-muted-foreground",
			children: label
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "mt-[1.4cqw] font-display text-[5cqw] font-semibold text-brand-ink",
			children: value
		})]
	});
}
...
function ProgressExperience() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "px-[7.1cqw] pt-[7.1cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-display text-[8.6cqw] font-bold text-brand-ink",
					children: "Insights"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-[0.7cqw] text-[4cqw] text-muted-foreground",
					children: "Last 7 days"
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-[7.1cqw] grid grid-cols-2 gap-[4.3cqw] px-[7.1cqw]",
				children: stats.map((stat) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: `font-display text-[8.6cqw] font-bold tabular-nums ${stat.tone === "success" ? "text-success" : "text-brand-ink"}`,
						children: [stat.value, stat.suffix && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "ml-[0.7cqw]",
							children: stat.suffix
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-[0.7cqw] text-[3.8cqw] text-muted-foreground",
						children: stat.label
					})]
				}, stat.label))
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-[8.6cqw] px-[7.1cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-display text-[5.7cqw] font-semibold text-brand-ink",
					children: "Accuracy trend"
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-[4.3cqw] px-[7.1cqw] pb-[8.6cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					"data-insight-chart": true,
					className: "rounded-2xl bg-card p-[5.7cqw] shadow-soft",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center gap-[2.9cqw]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "font-display text-[7.1cqw] font-bold tabular-nums text-brand-ink",
							children: [last, "%"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							className: "rounded-xl bg-success-soft px-[2.9cqw] py-[0.7cqw] text-[3.5cqw] font-semibold text-success",
							children: [
								delta >= 0 ? "+" : "",
								delta,
								" pts this week"
						...
						className: "mt-[4.3cqw] border-t border-border pt-[4.3cqw]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
							viewBox: "0 0 260 64",
							className: "h-[22.9cqw] w-full overflow-visible",
							"aria-hidden": "true",
							children: [
							...
							className: "mt-[2.9cqw] flex justify-between text-[3.5cqw] text-muted-foreground",
...
var WEEK_LABEL = "Week 12 • Medical Biology";
var COMPLETED_COUNT = "1,240 students completed this weekly test.";
var FOOTNOTE = "Ranks are final for completed weekly tests. Ties are broken by completion time.";
var rankRingColor$1 = {
	1: "ring-warning",
	2: "ring-border",
	3: "ring-brand/50"
};
var rankBadgeColor$1 = {
	1: "bg-warning",
	2: "bg-muted-foreground",
	3: "bg-brand/70"
};
/** Full-screen weekly leaderboard: podium, your-rank card, and closing note. */
function LeaderboardExperience() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex h-full flex-col bg-gradient-to-b from-brand-ink to-brand",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "border-b border-white/10 bg-card px-[5.7cqw] pb-[3.6cqw] pt-[7.1cqw]",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-[2.9cqw]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, {
					className: "h-[5cqw] w-[5cqw] text-brand-ink",
					...
					className: "font-display text-[4.6cqw] font-bold text-brand-ink",
			...
			className: "flex-1 space-y-[3.6cqw] overflow-hidden px-[5.7cqw] pt-[5.7cqw]",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[3.4cqw] font-medium text-white/90",
					children: COMPLETED_COUNT
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-[6cqw] bg-card p-[5cqw] shadow-soft",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-end justify-center gap-[4.3cqw] pt-[2.9cqw]",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Podium$1, {
								entry: second,
								size: "sm"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Podium$1, {
						...
						className: "mt-[5cqw] rounded-2xl bg-success-soft p-[3.6cqw]",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center gap-[2.1cqw]",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "text-[3.7cqw] font-bold text-muted-foreground",
											children: ["#", profileUser.rank]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "flex h-[8.6cqw] w-[8.6cqw] shrink-0 items-center justify-center rounded-full bg-surface-2",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserRound, {
												className: "h-[4.3cqw] w-[4.3cqw] text-muted-foreground",
												strokeWidth: 2
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[3.1cqw] font-semibold uppercase tracking-wide text-muted-foreground",
											children: "Your rank"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "text-[4cqw] font-semibold text-brand-ink",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "text-[3.7cqw] font-bold text-brand-ink",
										children: [profileUser.xp.toLocaleString(), " XP"]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "text-[3.1cqw] text-muted-foreground",
										children: [
											"↑",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-[2.9cqw] h-[2.1cqw] overflow-hidden rounded-full bg-white/60",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-[2.1cqw] text-[3.4cqw] text-muted-foreground",
								children: [
									"You're",
									" ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "px-[4.3cqw] text-center text-[3.3cqw] text-white/70",
					children: FOOTNOTE
				})
			]
		})]
...
function Podium$1({ entry, size, crown }) {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: `flex ${dim} items-center justify-center rounded-full bg-surface-2 ring-[1.4cqw] ring-offset-[0.7cqw] ring-offset-card ${rankRingColor$1[entry.place]}`,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserRound, {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: `absolute -bottom-[1.4cqw] left-1/2 flex h-[5.7cqw] w-[5.7cqw] -translate-x-1/2 items-center justify-center rounded-full text-[3cqw] font-bold text-white ring-[0.7cqw] ring-card ${rankBadgeColor$1[entry.place]}`,
						children: entry.place
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-[2.9cqw] text-[3.5cqw] font-semibold text-brand-ink",
				children: entry.name
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "text-[3.1cqw] text-muted-foreground",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "px-[5.7cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-2xl border border-teal/40 bg-teal-soft p-[5.7cqw]",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[3.4cqw] font-semibold uppercase tracking-[0.2em] text-brand",
							children: "Word of the Day"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-[2.9cqw] font-display text-[7.1cqw] font-semibold text-brand-ink",
							children: wordOfTheDay.term
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-[2.9cqw] text-[4cqw] leading-relaxed text-muted-foreground",
							children: wordOfTheDay.definition
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "mt-[5.7cqw] inline-flex rounded-full bg-brand px-[4.3cqw] py-[1.4cqw] text-[3.5cqw] font-medium text-primary-foreground",
							children: "Learned"
						})
					]
				})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-[7.1cqw] px-[7.1cqw] text-[3.4cqw] font-semibold uppercase tracking-[0.2em] text-muted-foreground",
				children: "Earlier this week"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
				className: "mt-[2.9cqw] space-y-[2.9cqw] px-[5.7cqw]",
				children: learned.map((term) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					...
					children: [term, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "text-[3.4cqw] text-success",
						children: "Learned"
					})]
				}, term))
			})
...
var steps = [
	...
	},
	{
		...
		screen: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LeaderboardExperience, {})
	},
	{
		id: "word",
...
function Copy({ step, index, className, headingTag = "h3" }) {
	const HeadingComp = headingTag;
	const headingProps = headingTag === "p" ? {
		role: "heading",
		"aria-level": 3
	} : {};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadingComp, {
				"data-panel-item": true,
				...headingProps,
...
function ProfileExperience() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "border-b border-border bg-card px-[5.7cqw] pb-[3.6cqw] pt-[5.7cqw]",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "font-display text-[6.4cqw] font-bold text-brand-ink",
					children: "Profile"
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex-1 space-y-[5cqw] overflow-hidden px-[5cqw] pt-[5cqw]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "rounded-2xl bg-card p-[4.3cqw] shadow-soft",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-start justify-between",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-[3.6cqw]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Avatar, { size: "h-[14.3cqw] w-[14.3cqw]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-[4.5cqw] font-semibold text-brand-ink",
									children: profileUser.name
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-[3.5cqw] text-muted-foreground",
							...
							className: "mt-[3.6cqw] grid grid-cols-3 divide-x divide-border border-t border-border pt-[3.6cqw]",
							children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-display text-[4.9cqw] font-bold text-brand-ink",
							children: "Leaderboard"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-[2.1cqw]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full border border-border px-[2.9cqw] py-[0.7cqw] text-[3.3cqw] font-semibold text-brand-ink",
								children: "Weekly"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full bg-muted-foreground/80 px-[2.9cqw] py-[0.7cqw] text-[3.3cqw] font-semibold text-white",
								children: "All time"
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-[2.9cqw] rounded-2xl bg-card p-[4.3cqw] shadow-soft",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-end justify-center gap-[4.3cqw]",
							children: [
							...
							className: "mt-[4.3cqw] rounded-xl bg-success-soft p-[3.6cqw]",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center justify-between",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Avatar, {
												size: "h-[8.6cqw] w-[8.6cqw]",
												iconSize: "h-[4.3cqw] w-[4.3cqw]"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-[3.1cqw] font-semibold uppercase tracking-wide text-muted-foreground",
												children: "Your rank"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-display text-[4.9cqw] font-semibold text-brand-ink",
						children: "Accounts"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center justify-around border-t border-border bg-card px-[2.9cqw] py-[3.6cqw]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, {
						className: "h-[5.7cqw] w-[5.7cqw] text-muted-foreground",
						strokeWidth: 2
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquarePen, {
						className: "h-[5.7cqw] w-[5.7cqw] text-muted-foreground",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, {
						className: "h-[5.7cqw] w-[5.7cqw] text-brand",
						strokeWidth: 2
					})
				]
			})
...
function Stat({ value, label }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "font-display text-[5cqw] font-bold text-brand-ink",
			children: value
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-[3.3cqw] text-muted-foreground",
			children: label
...
function Avatar({ size, iconSize = "h-[7.1cqw] w-[7.1cqw]" }) {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageContainer, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PhoneMockup, {
						className: "w-[min(56vw,14rem)] lg:w-[min(25vw,17.5rem)]",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfileExperience, {})
					})
				})
			]
		})
